    ...
    <div class="site-blocks-cover overlay" style="background-image: url({{ $venue->getFirstMediaUrl('main_photo') }});" data-aos="fade" data-stellar-background-ratio="0.5">
        <div class="container">
            <div class="row align-items-center justify-content-center text-center">
                <div class="col-md-10">
                    <span class="d-inline-block text-white px-3 mb-3 property-offer-type rounded">Venue Details of</span>
            ...
            <div class="row">
                <div class="col-lg-8" style="margin-top: -150px;">
                    ...
                    <div class="bg-white">
                        ...
                        <div class="row mt-5">
                            <div class="col-12">
                                <h2 class="h4 text-black mb-3">Event Gallery</h2>
                            </div>
                ...
                <div class="col-lg-4 pl-md-5">
                    ...
                    <div class="bg-white widget border rounded">
                        ...
                        <h3 class="h4 text-black widget-title mb-3">Contact Sales</h3>
