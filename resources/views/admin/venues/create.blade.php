    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.venues.store") }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <select class="form-control select2 {{ $errors->has('event_types') ? 'is-invalid' : '' }}" name="event_types[]" id="event_types" multiple>
                    @foreach($event_types as $id => $event_types)
                        <option value="{{ $id }}" {{ in_array($id, old('event_types', [])) ? 'selected' : '' }}>{{ $event_types }}</option>
                    @endforeach
                </select>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('people_minimum') ? 'is-invalid' : '' }}" type="number" name="people_minimum" id="people_minimum" value="{{ old('people_minimum', '') }}" step="1">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('people_maximum') ? 'is-invalid' : '' }}" type="number" name="people_maximum" id="people_maximum" value="{{ old('people_maximum', '') }}" step="1">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('price_per_hour') ? 'is-invalid' : '' }}" type="number" name="price_per_hour" id="price_per_hour" value="{{ old('price_per_hour', '') }}" step="0.01">
